...
const translations = {
    en: {
        who: "Who I Am",
        desc: "I'm Nguyen Trong Duc - a <strong>software engineering student</strong> passionate. I love figuring things out on my own, learning through real-world projects, and constantly exploring everything from programming and systems to developer tools. For me, every line of code is a way to understand how the world works - and that's what keeps me eager to learn more each day.",
        project: "Featured Project",
        subtitle: "Putting myself in the user's shoes to build truly meaningful solutions.",
        donate: "Support",
        openSource: "An open-source browser extension",
        myProjects: "View projects",
        ...
        `,
        askQuestion: "Send Feedback",
        copyright: "© 2025 Duck CIT",
        modalTitle: "Send Feedback",
        modalDesc: "I'd love to hear from you! Whether you have a question, feedback, want to collaborate, or just want to say hello, feel free to reach out. I'll get back to you as soon as possible.",
        ...
        pricingCurrency: "$",
        pricingPrice: "0",
        pricingDescription: "All projects are completely free, and I'll always keep them that way",
        pricingNote: "* If you'd like to show some love, a $1 donation would make my day (but no pressure, really).",
        projectsTitle: "View projects",
    ...
    vi: {
        who: "Tôi Là Ai",
        desc: "Mình là Nguyễn Trọng Đức - một <strong>sinh viên kỹ thuật phần mềm</strong>. Mình thích tự mày mò, học hỏi qua dự án thực tế và không ngừng khám phá từ lập trình, hệ thống đến các công cụ hỗ trợ phát triển phần mềm. Với mình, mỗi dòng code là một cách để hiểu thế giới hoạt động như thế nào - và đó là điều khiến mình luôn muốn học nhiều hơn mỗi ngày.",
        project: "Dự Án Tiêu Biểu",
        subtitle: "Đặt mình vào vị trí người dùng để tạo ra giải pháp thực sự hữu ích",
        donate: "Ủng hộ",
        openSource: "Một tiện ích mở rộng mã nguồn mở",
        myProjects: "Xem các dự án",
        ...
        `,
        askQuestion: "Gửi phản hồi",
        copyright: "© 2025 Duck CIT",
        modalTitle: "Gửi phản hồi",
        modalDesc: "Mình rất mong được lắng nghe từ bạn! Dù bạn có câu hỏi, góp ý, muốn hợp tác hay chỉ đơn giản muốn chào hỏi, hãy cứ liên hệ. Mình sẽ phản hồi bạn sớm nhất có thể.",
        namePlaceholder: "Tên của bạn",
        emailPlaceholder: "Email của bạn",
        questionPlaceholder: "Câu hỏi của bạn",
        submitButton: "Gửi",
        pricingTitle: "Giá Cả",
        pricingSubtitle: "Mở khóa quyền truy cập vào tất cả các dự án sáng tạo của mình",
        pricingCurrency: "$",
        pricingPrice: "0",
        pricingDescription: "Các dự án hoàn toàn miễn phí, và mình sẽ luôn giữ nó như vậy",
        pricingNote: "* Nếu bạn muốn thể hiện chút tình cảm, một khoản đóng góp 1K cũng sẽ khiến mình vui cả ngày (nhưng không ép buộc đâu, thật đấy)",
        projectsTitle: "Xem các dự án",
